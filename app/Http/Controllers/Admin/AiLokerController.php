...
class AiLokerController extends Controller
{
    public function scanImage(Request $request)
    {
        ...
        \"deskripsi\": \"Wajib tuliskan draf 1 paragraf ringkas mengenai Deskripsi Pekerjaan (Job Description) yang menjelaskan esensi peran posisi tersebut secara profesional di awal. SETELAH ITU, kamu WAJIB menyambungnya dengan detail informasi lowongan terstruktur yang dipisahkan oleh dua baris baru (\\n\\n) tepat seperti contoh format di bawah ini (jangan ada poin yang dikurangi atau dilewati):\\n\\nInformasi Lowongan: [Nama Perusahaan & Wilayah]\\nInstansi: [Nama Instansi]\\nPosisi yang Dibuka: [Sebutkan semua posisi yang ada]\\nAlamat Kantor/Toko: [Alamat Lengkap sesuai gambar]\\nCara Melamar: [Keterangan lengkap alur kirim berkas/email/syarat fisik cetak jika ada]\\nInfo Kontak HRD: [Nomor HP/WA jika ada]\",
